...
// // MARK: DFA
const DFA_BLOCK_SIZE_BYTES: usize = 1 << 12;
...
//     _arena: Corrida::<DFA_BLOCK_SIZE_BYTES>,
...
//     pub fn new(arena: Corrida::<DFA_BLOCK_SIZE_BYTES>, start_node: NonNull<PartialState<Σ>>) -> Self {
//         Self {
//             _arena: arena,
//             start_node,
//             _boo: PhantomData
...
//     /// Creates a new DFA with no vertices, but an Arena ready for pushing verts.
//     pub fn new(arena: Corrida::<DFA_BLOCK_SIZE_BYTES>, start_node: NonNull<CompleteState<Σ>>) -> Self {
//         Self {
//             _arena: arena,
//             start_node,
//             _boo: PhantomData
